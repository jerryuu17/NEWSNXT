        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {newsData.slice(0, visibleNews).map((news, index) => <NewsCard key={index} title={news.title} description={news.description} image={news.image} category={news.category} source={news.source} sourceName={news.sourceName} isCrowdsourced={news.isCrowdsourced} verificationStatus={news.verificationStatus} publishedAt={news.publishedAt} />)}
            </div>
